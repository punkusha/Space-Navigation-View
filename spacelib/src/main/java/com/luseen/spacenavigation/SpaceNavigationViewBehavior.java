...
final class SpaceNavigationViewBehavior<V extends View> extends VerticalScrollingBehavior<V> {
    ...
    public static <V extends View> SpaceNavigationViewBehavior<V> from(@NonNull V view) {
        ...
        CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.LayoutParams) params)
                .getBehavior();
        if (!(behavior instanceof SpaceNavigationViewBehavior)) {
            throw new IllegalArgumentException(
                    "The view is not associated with SpaceNavigationViewBehavior");
        }
        return (SpaceNavigationViewBehavior<V>) behavior;
    }
